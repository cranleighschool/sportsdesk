...
<?php print "CURRENT WEEK:".$current_week; ?>

<a href="/week/<?php print week_tax_slug($current_week+1); ?>">Next Week</a>
<br />
<a href="/week/<?php print week_tax_slug($current_week-1); ?>">Last Week</a>

<h2>This Week : <?php print week_tax(); ?></h2>
